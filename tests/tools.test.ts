...
describe("createEjentumTools factory", () => {
  ...
  it("each tool has description, parameters, and execute", () => {
    ...
    for (const key of Object.keys(tools)) {
      const t = (tools as Record<string, { description: string; parameters: unknown; execute: unknown }>)[key];
...
describe("per-tool factories", () => {
  it("createReasoningTool returns a Tool with non-empty description", () => {
